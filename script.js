...
async function generateAI() {
    ...
    let KeywordURL = "https://fasfasv-b58b7ed96d6a.herokuapp.com/generate_keywords?prompt= " + input;
    let sloganURL = "https://fasfasv-b58b7ed96d6a.herokuapp.com/generate_snippet?prompt= " + input;
